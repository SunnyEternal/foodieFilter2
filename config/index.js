...
module.exports = {
  dev: {
    ...
    // proxyTable: {
    //   "/api":{
    //     target: "http://foodie-beta.kajicam.com/fs/api",
    //     "changeOrigin": true,
    //     "pathRewrite": {
    //             "^/api": "/" 
    //      },
    ...
    host: '10.35.33.170', // can be overwritten by process.env.HOST
    // host: '10.35.36.231', // can be overwritten by process.env.HOST
