<template>
  <div class="btn">
    ...
    <em @touchstart="handTouchstart" @touchend="handTouchend" 
      @click="emitFn" :class="{tap: tapState}" 
      :style="{color: sty.color, width: sty.width,
              backgroundImage: 'radial-gradient(' + sty.sColor + ' 0%,' + sty.eColor + ' 85%,'+ sty.eColor + ')'}"
          >
          {{sty.value}}
    </em>
  </div>
...
.btn{
  ...
  em{
    display:block;
    font-size: .36rem;width:3.48rem;line-height:.88rem;
